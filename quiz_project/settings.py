...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-+63#6%*o4*$b$xrv*r2$!pto_!i(id3b_7wad=t&8u-w#gs*pz')
...
MIDDLEWARE = [
    ...
    'quiz_app.middleware.ErrorLoggingMiddleware',  # Add our custom error logging middleware
]
